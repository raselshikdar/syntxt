...
export default function SettingsProfile({ onBack }: { onBack: () => void }) {
      ...
      <div className="max-w-2xl mx-auto px-4 pt-6 space-y-6">
        ...
        <div className="border border-border rounded-md bg-card overflow-hidden">
          <div className="relative h-24 bg-gradient-to-r from-muted to-accent">
            ...
            <input ref={bannerInputRef} type="file" accept="image/jpeg,image/png,image/webp" onChange={e => { const f = e.target.files?.[0]; if (f) uploadImage(f, 'banners', 'banner', 'banner_url'); }} className="hidden" />
          </div>
          <div className="px-5 pb-5">
            <div className="flex items-end -mt-8">
              ...
              <input ref={avatarInputRef} type="file" accept="image/jpeg,image/png,image/webp" onChange={e => { const f = e.target.files?.[0]; if (f) uploadImage(f, 'avatars', 'avatar', 'avatar_url'); }} className="hidden" />
            </div>

...
function usePostDetail(postId: string | undefined) { 
  ...
  return useQuery({ 
    ...
    queryFn: async (): Promise<{ post: PostWithProfile | null; replies: PostWithProfile[]; parentPosts: PostWithProfile[] }> => { 
      ...
      // ৪. রিপোস্টের জন্য অরিজিনাল কন্টেন্ট লোড করা
      ...
      // ৫. প্রোফাইল এবং মেটাডেটা প্রসেসিং (আপনার অরিজিনাল ম্যাপার লজিক)
  ...
  return ( 
    <div className="min-h-screen bg-background pb-20"> 
      ...
      <div className="max-w-2xl mx-auto px-4 pt-4 space-y-4"> 
        ...
        {/* প্যারেন্ট পোস্ট রেন্ডারিং (যদি থাকে) */}
